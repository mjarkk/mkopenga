      ...
      <div className="center">
        ...
        <div className="question">
          ...
          <div className="a">
            ...
            You can also always peek my interest with things like computer components and also their inner workings, Science, Psychology and socal behavior though
        ...
        <div className="question">
          <p className="q">Job?</p>
          <div className="a">
            At my day to day job i'm a backend developer mainly writing GoLang and TypeScript code at <a href="https://klippa.com">Klippa</a> a document processing company.
          </div>
        </div>
        <div className="question">
